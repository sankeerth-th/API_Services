...
SECRET_KEY = 'django-insecure-^h@1zd#!=jkqesby$_k-c^t%8ajc7h39t+y-&u6w!3-9g2@b(v'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': ' ',   # INPUT_REQUIRED {database_password}
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_FILTER_BACKENDS': ['django_filters.rest_framework.DjangoFilterBackend'],  # Added for filtering support
    'DEFAULT_PAGINATION_CLASS': 'rest_framework.pagination.LimitOffsetPagination',  # Added for pagination support
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'when': 'midnight',  # Rotate the log file daily
    ...
    'loggers': {
        ...
        'library': {  # Assuming 'library' is where most of your app's logging occurs
            'handlers': ['file'],
            'level': 'INFO',
            'propagate': False,
        },
